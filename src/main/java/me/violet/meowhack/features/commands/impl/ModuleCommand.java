...
import me.violet.meowhack.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Meowhack.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Meowhack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Meowhack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Meowhack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
