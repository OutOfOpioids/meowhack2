package me.violet.meowhack.features.modules;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = Meowhack.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Meowhack.moduleManager.getModuleByName(name);
